...
} from "./chunk-25E4LJOL.js";
import {
  Button_default
} from "./chunk-JNHYRPPL.js";
import {
  require_warning
} from "./chunk-YDEHNOWR.js";
import {
  require_prop_types
...
function useUncontrolledProp(propValue, defaultValue, handler) {
  ...
  return [isProp ? propValue : stateValue, (0, import_react.useCallback)((value, ...args) => {
    if (handler)
      handler(value, ...args);
    setState(value);
  }, [handler])];
...
function useSafeState(state) {
  ...
  return [state[0], (0, import_react2.useCallback)(function(nextState) {
    if (!isMounted())
      return;
...
var $704cf1d3b684cc5c$var$SSRContext = (0, import_react6.default).createContext($704cf1d3b684cc5c$var$defaultContext);
...
function $704cf1d3b684cc5c$var$useCounter(isDisabled = false) {
  let ctx = (0, import_react6.useContext)($704cf1d3b684cc5c$var$SSRContext);
