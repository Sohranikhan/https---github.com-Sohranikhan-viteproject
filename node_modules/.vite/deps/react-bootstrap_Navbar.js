import {
  contains,
  useWindow
} from "./chunk-VIU456ZL.js";
import {
  NavbarContext_default,
  SelectableContext_default,
  dataAttr,
  qsa
} from "./chunk-327C3WJP.js";
import {
  ENTERED,
  ENTERING,
  EXITED,
...
function useTransition({
  ...
  const isInitialRef = (0, import_react8.useRef)(true);
...
function ImperativeTransition({
  ...
  const [exited, setExited] = (0, import_react8.useState)(!inProp);
  if (inProp && exited) {
    setExited(false);
  }
  ...
  const combinedRef = useMergedRefs_default(ref, children.ref);
  return exited && !inProp ? null : (0, import_react8.cloneElement)(children, {
    ref: combinedRef
  });
}
function renderTransition(Component, runTransition, props) {
  ...
  if (runTransition) {
    return (0, import_jsx_runtime5.jsx)(ImperativeTransition, Object.assign({}, props, {
      transition: runTransition
    }));
  }
  return (0, import_jsx_runtime5.jsx)(NoopTransition_default, Object.assign({}, props));
}
...
function useModalManager(provided) {
  ...
  const modal = (0, import_react9.useRef)({
    dialog: null,
    backdrop: null
  });
  return Object.assign(modal.current, {
    ...
    setDialogRef: (0, import_react9.useCallback)((ref) => {
      modal.current.dialog = ref;
    }, []),
    setBackdropRef: (0, import_react9.useCallback)((ref) => {
      modal.current.backdrop = ref;
    }, [])
  });
}
var Modal = (0, import_react9.forwardRef)((_ref, ref) => {
  let {
    show = false,
    role = "dialog",
    className,
    ...
    restoreFocusOptions,
    renderDialog,
    renderBackdrop = (props) => (0, import_jsx_runtime6.jsx)("div", Object.assign({}, props)),
  ...
  const [exited, setExited] = (0, import_react9.useState)(!show);
  const lastFocusRef = (0, import_react9.useRef)(null);
  (0, import_react9.useImperativeHandle)(ref, () => modal, [modal]);
  ...
  const removeFocusListenerRef = (0, import_react9.useRef)();
  const removeKeydownListenerRef = (0, import_react9.useRef)();
  ...
  let dialog = renderDialog ? renderDialog(dialogProps) : (0, import_jsx_runtime6.jsx)("div", Object.assign({}, dialogProps, {
    children: React6.cloneElement(children, {
      role: "document"
    })
  }));
  ...
  return (0, import_jsx_runtime6.jsx)(import_jsx_runtime7.Fragment, {
    children: import_react_dom.default.createPortal((0, import_jsx_runtime8.jsxs)(import_jsx_runtime7.Fragment, {
...
var Fade = React7.forwardRef(({
  ...
  return (0, import_jsx_runtime9.jsx)(TransitionWrapper_default, {
    ...
    onEnter: handleEnter,
    childRef: children.ref,
    children: (status, innerProps) => React7.cloneElement(children, {
      ...innerProps,
...
var divWithClassName_default = (className) => React13.forwardRef((p, ref) => (0, import_jsx_runtime15.jsx)("div", {
  ...p,
  ref,
...
var Offcanvas = React14.forwardRef(({
  ...
  const renderBackdrop = (0, import_react12.useCallback)((backdropProps) => (0, import_jsx_runtime16.jsx)("div", {
    ...backdropProps,
...
var Navbar = React16.forwardRef((props, ref) => {
  const {
  ...
  return (0, import_jsx_runtime20.jsx)(NavbarContext_default.Provider, {
    value: navbarContext,
    children: (0, import_jsx_runtime20.jsx)(SelectableContext_default.Provider, {
